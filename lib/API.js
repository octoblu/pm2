 ...
 * @param {String}  [opts.daemon_rpc_port=null]     override daemon RPC port
 * @param {String}  [opts.daemon_pub_port=null]     override daemon pub port
 * @param {String}  [opts.interactor_rpc_port=null]     override interactor pub port
 */
var API = module.exports = function(opts) {
  ...
  this.daemon_rpc_port = process.env.DAEMON_RPC_PORT || opts.daemon_rpc_port || null;
  this.daemon_pub_port = process.env.DAEMON_PUB_PORT || opts.daemon_pub_port || null;
  this.interactor_rpc_port = process.env.INTERACTOR_PUB_PORT || opts.interactor_rpc_port || null;
  ...
  if (this.daemon_rpc_port) {
    conf.DAEMON_RPC_PORT = this.daemon_rpc_port
  }
  if (this.daemon_pub_port) {
    conf.DAEMON_PUB_PORT = this.daemon_pub_port
  }
  if (this.interactor_rpc_port) {
    conf.INTERACTOR_RPC_PORT = this.interactor_rpc_port
  }
